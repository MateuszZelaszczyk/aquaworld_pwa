...
const Navi =()=>{
    ...
    <div className={style.MainNaviMenu}>
      ...
      <ul className={style.ElementsList}>
        ...
        <li className={style.ListItem}>,<NavLink className={style.Link} to="/newaqua">+Dodaj akwarium</NavLink></li>
        <li className={style.ListItem}>
          <button className={style.ProfilContainer} onClick={() => setVisible(!visible)}>
